...
class DataFetcher:
    ...
    def get_stock_daily(self, code, days=120):
        ...
        sources = [
            ...
            ("通达信", lambda: ak.stock_zh_a_daily(
            ...
            for attempt in range(MAX_RETRIES):
                try:
                    ...
                    if df is not None and not df.empty:
                        return self._normalize(df, _DAILY_COLS, code)
...
with open('data_fetcher.py', 'w', encoding='utf-8') as f:
    f.write(new_content)
print("data_fetcher.py rewritten successfully")
print("Lines:", new_content.count('\n'))
print("DataFetcher count:", new_content.count('class DataFetcher'))
